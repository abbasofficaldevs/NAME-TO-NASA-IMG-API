...
<img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=22&pause=1000&color=FC4C02&center=true&vCenter=true&width=750&lines=Turn+Any+Name+Into+a+Satellite+Image;No+API+Key+%F0%9F%94%93;Realistic+Aerial+Letters;Perfect+For+Bots+%7C+Games+%7C+Social+Media" alt="Typing SVG" />
...
> **🛰️ Enter a name – get a satellite photo that spells out that name from above.**
...
```diff
+ 🛰️  Name → Satellite Image in < 1 second
+ 🔓  No API Key Required — Works Out of The Box
+ 🎨  3 Different Aerial Variants per Letter (A‑Z)
+ 🌍  Realistic terrain‑style letters
+ 📤  Auto‑Upload to tmpfiles.org (no local storage)
+ 💻  Lightweight Flask Backend – runs anywhere
+ 🔠  Supports A‑Z (case‑insensitive), ignores other chars
